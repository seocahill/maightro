...
class HelperTest < Test::Unit::TestCase
  ...
  def test_route_lookup
    ...
    assert_equal @tp.find_route('Ballina', 'Foxford')[0], %i[nephin costello_return]
    assert_equal @tp.find_route('Castlebar', 'Westport')[0], %i[nephin covey_return]
  ...
  def test_stops_lookup
    ...
    assert_equal @tp.find_route('Ballina', 'Westport')[1],
                 ['Ballina', 'Foxford', 'Manulla Junction', 'Castlebar', 'Westport']
    assert_equal @tp.find_route('Westport', 'Ballyhaunis')[1],
                 ['Westport', 'Castlebar', 'Manulla Junction', 'Claremorris', 'Ballyhaunis']
  end
