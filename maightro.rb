...
get '/analysis' do
  ...
  @baseline = Option1.new.run_analysis if @scenario != 'Option1'
...
before do
  ...
  headers['Access-Control-Allow-Headers'] =
    'Accept, Authorization, Origin, HX-Boosted, HX-Current-URL, HX-History-Restore-Request, HX-Prompt, HX-Request, HX-Target, HX-Trigger-Name, HX-Trigger'
end
...
options '*' do
  ...
  response.headers['Access-Control-Allow-Headers'] =
    'X-Requested-With, X-HTTP-Method-Override, Content-Type, Cache-Control, Accept, HX-Boosted, HX-Current-URL, HX-History-Restore-Request, HX-Prompt, HX-Request, HX-Target, HX-Trigger-Name, HX-Trigger'
end
